...
In this notebook, we will use the Theoph Dataset to practice subsetting and plotting in R. The dataset and plotting system are built-in, so there is not need to download any additional packages for expanded plotting capabilities.
